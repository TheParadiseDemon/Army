...
MilitaryUnit::MilitaryUnit(int militaryDivisionNumber,
                           ...
                           int platoon,
                           int squad) {
    this->militaryDivision.second = std::move(militaryDivisionLettter);
    this->militaryDivision.first = std::move(militaryDivisionNumber);
    this->battalion = std::move(battalion);
    this->platoon = std::move(platoon);
    this->company = std::move(company);
    this->squad = std::move(squad);
}
